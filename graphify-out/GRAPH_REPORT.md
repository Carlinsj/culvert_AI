...
## Corpus Check
- 72 files · ~120,740 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1067 nodes · 2604 edges · 52 communities (34 shown, 18 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 234 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0760a05c`
...
Cohesion: 0.07
Nodes (41): bboxAroundLatLng(), buildSearchText(), candidateCanvasColor(), candidateCanvasLabel(), clampIntegerValue(), clampLatitude(), clampLongitude(), clampNumberValue() (+33 more)
...
Cohesion: 0.10
Nodes (45): bindDetailCloseAction(), bindFeedbackActions(), compactEvidenceSummary(), definitionItem(), detailCell(), discoveryStatusLabel(), draftPointSaveHtml(), drainageLabel() (+37 more)
...
Cohesion: 0.06
Nodes (82): Point, _county_boundary(), _download_if_missing(), download_ulster_census_inputs(), _normalize_linear_water(), _normalize_roads(), GeoDataFrame, Path (+74 more)
...
Cohesion: 0.26
Nodes (15): centerMapOnPoint(), draftPointIcon(), draftPointStartLatLng(), handleMapClick(), makeFieldCulvertId(), normalizeLatLng(), renderDraftPointDetail(), renderDraftPointMarker() (+7 more)
...
Cohesion: 0.09
Nodes (44): addObservation(), bindDraftPointActions(), bindMovedRepairAction(), cancelPlacePointMode(), clearDetail(), clearMovedOffsetOverlay(), compareFeaturesForList(), FIELD_OBSERVATION_VIEWS (+36 more)
...
Cohesion: 0.21
Nodes (22): appendLocalObservationStatus(), applyDashboardData(), clearFeedbackWriteToken(), clearLocalObservations(), deleteObservationById(), fetchFeedbackWrite(), fetchFirst(), fetchFirstOptional() (+14 more)
...
Cohesion: 0.16
Nodes (22): clusterCanvasCandidateItems(), compareCanvasCandidatePriority(), declutterCanvasItems(), distanceMeters(), featureLatLng(), isRouteCandidateId(), latLngFromValues(), longitudeOrNull() (+14 more)

### Community 55 - "isMovedObservation"
Cohesion: 0.22
Nodes (13): bucketFromScore(), fieldObservationView(), isConfirmedPredictionObservation(), isMovedObservation(), movedRepairActionHtml(), movedRepairContextForObservation(), observationDisplayCode(), observationIcon() (+5 more)
...
- **Why does `write_vector()` connect `Point Analysis` to `renderDetail`, `Census Inputs`?**
...
- **Why does `run_demo_pipeline()` connect `Census Inputs` to `Feature Engineering`, `Model Training`, `Discovery Scoring`, `CLI Pipeline`, `Point Analysis`?**
